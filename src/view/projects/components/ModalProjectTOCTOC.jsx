    ...
    <div>
      ...
      >
        ...
        <div className={classes.fond}>
          ...
          <img src="./assets/post.png" alt="logo" width="50" height="100%" style={{marginRight: "10px"}} />
          
          </div>
          <iframe width="869" height="492" src="https://www.youtube.com/embed/yPvnyLetnj8?amp;autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
